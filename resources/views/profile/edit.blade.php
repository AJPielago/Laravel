...
@section('content')
<div class="min-h-screen bg-gradient-to-r from-indigo-500 to-purple-500 py-8 w-full">
...
<style>
    /* Adding CSS to ensure full width background */
    html, body {
        margin: 0;
        padding: 0;
        width: 100%;
    ...
    /* Make sure the gradient covers the entire width */
    .bg-gradient-to-r {
        width: 100vw;
        position: relative;
        left: 50%;
